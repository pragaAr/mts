...
<main class="main">
  <section class="product section container" id="products">
    <h2 class="section__title-center">
      <?php if (!empty($iduri)) { ?>
        <?= ucwords($merk->nama_merk) ?> List
      <?php } else { ?>
        Unknown Brands
      <?php } ?>
    </h2>
    <form action="" class="form__search_product">
      <input type="text" class="form__control" name="merk-name" placeholder="Search Brands" autocomplete="off">
      ...
      <div class="product__container grid">
        <?php foreach ($product as $product) : ?>
          <article class="product__card">
            ...
            <a href="https://wa.me/628122564507?text=Saya%20ingin%20mendapatkan%20info%20product%20<?= ucwords($product->product_name) ?>%20" class="product__button" target="_blank">
